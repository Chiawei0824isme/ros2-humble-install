...
echo "2. ros2 run demo_nodes_cpp talker      # C++ 範例發布者"
echo "3. ros2 run demo_nodes_cpp listener    # C++ 範例訂閱者"
echo "4. ros2 run demo_nodes_py talker       # Python 範例發布者"
echo "5. ros2 run demo_nodes_py listener     # Python 範例訂閱者"
